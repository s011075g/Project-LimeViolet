...
{
	_render->DrawObject(static_cast<TransformComponent*>(components[0]),
	                    static_cast<RenderableMeshComponent*>(components[1]),
	                    static_cast<MaterialComponent*>(components[2]));
}
