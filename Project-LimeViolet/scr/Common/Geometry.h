...
private:
	...
	std::vector<Material*> _materials; //TODO make a materual manager to hold all the materials so that if objects use the same material, it can be reused to save memory
public:
	Geometry() = default;
